...
export default function Home() {
  ...
  // Provide a safe fallback theme during hydration
  ...
  // Mouse follower animation for hero section - only render on client
  const MouseFollower = () => {
    ...
    <>
      ...
      <div className="relative min-h-screen overflow-hidden">
        ...
        <div className="absolute inset-0 z-0">
          ...
          {/* Only render complex animations and theme-dependent styles on client */}
          {isClient && (
            <>
              ...
              <div
                ...
                style={getBackgroundStyles(safeTheme).gridBackground}
              />
              ...
              >
                <motion.path
                  ...
                  stroke={getPathColors(safeTheme).primary}
                  strokeWidth={2}
                  fill="none"
                  animate={{
                    d: [
                ...
                <motion.path
                  ...
                  stroke={getPathColors(safeTheme).secondary}
                  strokeWidth={2}
                  fill="none"
                  animate={{
                    d: [
              ...
              <div className="absolute inset-0 overflow-hidden">
                ...
                <motion.div
                  ...
                  style={getBackgroundStyles(safeTheme).topRightAccent}
                  animate={{
                    scale: [1, 1.1, 1],
                    x: [0, 20, 0],
                    y: [0, -20, 0],
                ...
                <motion.div
                  ...
                  style={getBackgroundStyles(safeTheme).bottomLeftAccent}
                  animate={{
                    scale: [1, 1.15, 1],
                    x: [0, -20, 0],
                    y: [0, 20, 0],
                ...
                <motion.div
                  ...
                  style={getBackgroundStyles(safeTheme).middleAccent}
                  animate={{
                    scale: [1, 1.1, 1],
                    x: [0, 30, 0],
                    y: [0, -15, 0],
                ...
                >
                  ...
                  >
                    <Button
                      ...
                      startContent={
                        <motion.div
                          animate={isClient ? { y: [0, -3, 0] } : {}}
                          transition={
                            isClient ? { duration: 2, repeat: Infinity } : {}
                          }
                        >
